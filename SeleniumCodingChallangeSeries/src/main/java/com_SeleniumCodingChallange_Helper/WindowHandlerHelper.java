...
public class WindowHandlerHelper
{
	
	private static WebDriver driver;
	private static Logger log = LoggerHelper.getLogger(WindowHandlerHelper.class);
	
	public WindowHandlerHelper(WebDriver diver, WebDriver driver)
	{
		this.driver= driver;
	}
	/**
